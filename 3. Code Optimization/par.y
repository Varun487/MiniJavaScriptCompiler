...
%token <rvalues> T_IF T_LABEL T_FALSE T_TRUE T_TVAR T_COLON
...
statement: T_TVAR T_ASSIGN value_prod
		   ...
		   | T_FALSE value_constants T_GOTO T_LVAR T_DELIM{check_update(&$1.value, &$2.value, &$3.value);printf("%s %s %s %s\n", $1.value, $2.value, $3.value, $4.value);}
		   | T_TRUE value_constants T_GOTO T_LVAR T_DELIM{check_update(&$1.value, &$2.value, &$3.value);printf("%s %s %s %s\n", $1.value, $2.value, $3.value, $4.value);}
